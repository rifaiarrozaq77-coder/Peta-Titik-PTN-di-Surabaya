...
lyr_univ_surabaya_2.set('fieldAliases', {'fid': 'fid', 'Nama': 'Nama', 'Kampus': 'Kampus', 'Deskripsi Univ_ BarbatovQS WUR': 'Deskripsi Univ_ BarbatovQS WUR', 'Deskripsi Univ_ BarbatovDidirikan': 'Deskripsi Univ_ BarbatovDidirikan', 'Deskripsi Univ_ BarbatovFakultas': 'Deskripsi Univ_ BarbatovFakultas', });
lyr_PTNSURABAYA_3.set('fieldAliases', {'fid': 'fid', 'Nama': 'Nama', 'Kampus': 'Kampus', 'Rank QS WUR': 'Rank QS WUR', 'tahun beridiri': 'tahun beridiri', 'Fak': 'Fak', 'foto': 'foto', });
lyr_aksesibilitas_univunion_1.set('fieldImages', {'fid': 'TextEdit', 'Access': 'TextEdit', });
lyr_univ_surabaya_2.set('fieldImages', {'fid': 'TextEdit', 'Nama': 'TextEdit', 'Kampus': 'TextEdit', 'Deskripsi Univ_ BarbatovQS WUR': 'TextEdit', 'Deskripsi Univ_ BarbatovDidirikan': 'TextEdit', 'Deskripsi Univ_ BarbatovFakultas': 'TextEdit', });
lyr_PTNSURABAYA_3.set('fieldImages', {'fid': 'TextEdit', 'Nama': 'TextEdit', 'Kampus': 'TextEdit', 'Rank QS WUR': 'TextEdit', 'tahun beridiri': 'TextEdit', 'Fak': 'TextEdit', 'foto': 'ExternalResource', });
lyr_aksesibilitas_univunion_1.set('fieldLabels', {'fid': 'no label', 'Access': 'inline label - always visible', });
lyr_univ_surabaya_2.set('fieldLabels', {'fid': 'no label', 'Nama': 'inline label - always visible', 'Kampus': 'inline label - always visible', 'Deskripsi Univ_ BarbatovQS WUR': 'inline label - always visible', 'Deskripsi Univ_ BarbatovDidirikan': 'inline label - always visible', 'Deskripsi Univ_ BarbatovFakultas': 'inline label - always visible', });
lyr_PTNSURABAYA_3.set('fieldLabels', {'fid': 'no label', 'Nama': 'inline label - always visible', 'Kampus': 'inline label - always visible', 'Rank QS WUR': 'inline label - always visible', 'tahun beridiri': 'inline label - always visible', 'Fak': 'inline label - always visible', 'foto': 'inline label - always visible', });
